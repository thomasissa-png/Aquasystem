// Régénère les baselines /la-maison après D-34 :
// - Nommage aligné « À propos » (H1 + metas + breadcrumb).
// - Reflets d'expertise : histoire (gamme d'ouvrage), panneau AS (CSTB/décennale),
//   panneau LTE (pépinière des Alluets, vivant).
...
const PAGES = [['la-maison', '/la-maison/']];
...
await browser.close();
console.log('DONE baselines la-maison D-34');
