...
export const metadata: Metadata = {
  ...
  description:
    'Bureau d’études paysager, création de parcs et jardins sur mesure en Yvelines et Hauts-de-Seine. En partenariat avec Les Terres Essentielles. 30 ans d’ancrage local.',
